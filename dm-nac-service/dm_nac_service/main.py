...
# Data
from dm_nac_service.config.database import get_database, sqlalchemy_engine
...
# from dm_nac_service.routes.file_upload import router as file_upload_router
...
# app.include_router(file_upload_router, prefix="")
